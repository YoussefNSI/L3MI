...
--
-- Client :  localhost
-- Généré le :  Lun 17 Mai 2021 à 18:19
...
--
-- Base de données :  `l3info_ct_20_2_dbsport`
--
CREATE DATABASE IF NOT EXISTS `l3info_ct_20_2_dbsport` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `l3info_ct_20_2_dbsport`;
...
CREATE TABLE `joueurs` (
  ...
  `idEquipe` bigint(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(15, '154876412345624', 'ONYME', 'ANNE', 8, NULL),
(18, '453158796548201', 'DIDACT', 'OTTO', 12, NULL);
