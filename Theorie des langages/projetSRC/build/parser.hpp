...
#line 68 "/c/Users/radou/Documents/GitHub/L3MI/Theorie des langages/projetSRC/build/parser.hpp"
...
namespace yy {
#line 208 "/c/Users/radou/Documents/GitHub/L3MI/Theorie des langages/projetSRC/build/parser.hpp"
...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // attributs
      char dummy3[sizeof (std::map<std::string, std::map<std::string, std::string>>)];
      ...
      // variable
      // valeurvar
      char dummy6[sizeof (std::variant<int, std::string, std::unique_ptr<Bloc>>)];
    };
        ...
        switch (this->kind ())
    {
      ...
      case symbol_kind::S_attributs: // attributs
        value.move< std::map<std::string, std::map<std::string, std::string>> > (std::move (that.value));
        break;
      ...
      case symbol_kind::S_valeurvar: // valeurvar
        value.move< std::variant<int, std::string, std::unique_ptr<Bloc>> > (std::move (that.value));
        break;
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::map<std::string, std::map<std::string, std::string>>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::map<std::string, std::map<std::string, std::string>>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::variant<int, std::string, std::unique_ptr<Bloc>>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::variant<int, std::string, std::unique_ptr<Bloc>>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
switch (yykind)
    {
      ...
      case symbol_kind::S_attributs: // attributs
        value.template destroy< std::map<std::string, std::map<std::string, std::string>> > ();
        break;
      ...
      case symbol_kind::S_variable: // variable
      case symbol_kind::S_valeurvar: // valeurvar
        value.template destroy< std::variant<int, std::string, std::unique_ptr<Bloc>> > ();
        break;
    ...
    struct symbol_type : basic_symbol<by_kind>
    {
      ...
      {
#if !defined _MSC_VER || defined __clang__
        YY_ASSERT ((token::PARAGRAPHE <= tok && tok <= token::IDENTIFIANT)
                   || (token::CHAINE <= tok && tok <= token::OPACITE));
#endif
      }
    };
    ...
    // Implementation of make_symbol for each token kind.
      ...
      static
      symbol_type
      make_PARAGRAPHE (std::string* v, location_type l)
      {
        return symbol_type (token::PARAGRAPHE, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_PARAGRAPHE (const std::string*& v, const location_type& l)
      {
        return symbol_type (token::PARAGRAPHE, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_IMAGE (std::string* v, location_type l)
      {
        return symbol_type (token::IMAGE, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_IMAGE (const std::string*& v, const location_type& l)
      {
        return symbol_type (token::IMAGE, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      {
        return symbol_type (token::DEFINE, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::DEFINE, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_TITREPAGE (std::string* v, location_type l)
      {
        return symbol_type (token::TITREPAGE, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_TITREPAGE (const std::string*& v, const location_type& l)
      {
        return symbol_type (token::TITREPAGE, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_STYLE (std::string* v, location_type l)
      {
        return symbol_type (token::STYLE, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_STYLE (const std::string*& v, const location_type& l)
      {
        return symbol_type (token::STYLE, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_ATTRIBUT (std::string* v, location_type l)
      {
        return symbol_type (token::ATTRIBUT, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_ATTRIBUT (const std::string*& v, const location_type& l)
      {
        return symbol_type (token::ATTRIBUT, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_PARENTHESE_OUVRANTE (std::string* v, location_type l)
      {
        return symbol_type (token::PARENTHESE_OUVRANTE, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_PARENTHESE_OUVRANTE (const std::string*& v, const location_type& l)
      {
        return symbol_type (token::PARENTHESE_OUVRANTE, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_PARENTHESE_FERMANTE (std::string* v, location_type l)
      {
        return symbol_type (token::PARENTHESE_FERMANTE, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_PARENTHESE_FERMANTE (const std::string*& v, const location_type& l)
      {
        return symbol_type (token::PARENTHESE_FERMANTE, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_ACCOLADE_OUVRANTE (std::string* v, location_type l)
      {
        return symbol_type (token::ACCOLADE_OUVRANTE, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_ACCOLADE_OUVRANTE (const std::string*& v, const location_type& l)
      {
        return symbol_type (token::ACCOLADE_OUVRANTE, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_ACCOLADE_FERMANTE (std::string* v, location_type l)
      {
        return symbol_type (token::ACCOLADE_FERMANTE, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_ACCOLADE_FERMANTE (const std::string*& v, const location_type& l)
      {
        return symbol_type (token::ACCOLADE_FERMANTE, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
...
#line 2031 "/c/Users/radou/Documents/GitHub/L3MI/Theorie des langages/projetSRC/build/parser.hpp"
