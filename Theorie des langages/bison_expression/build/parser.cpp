...
#line 57 "/home/yradouan/Documents/bison_expression/build/parser.cpp"
...
namespace yy {
#line 149 "/home/yradouan/Documents/bison_expression/build/parser.cpp"
...
#line 725 "/home/yradouan/Documents/bison_expression/build/parser.cpp"
    break;
...
#line 733 "/home/yradouan/Documents/bison_expression/build/parser.cpp"
    break;
...
#line 741 "/home/yradouan/Documents/bison_expression/build/parser.cpp"
    break;
...
#line 754 "/home/yradouan/Documents/bison_expression/build/parser.cpp"
    break;

  case 7: // affectation: IDENT '=' operation
#line 73 "parser/parser.yy"
                        {
        try {
            double val = yystack_[0].value.as < ExpressionPtr > ()->calculer(driver.getContexte());
            driver.setVariable(yystack_[2].value.as < std::string > (), val);
            std::cout << "#-> " << yystack_[2].value.as < std::string > () << " = " << val << std::endl;
        } catch(const std::exception& err) {
            std::cerr << "#-> " << err.what() << std::endl;
        }
    }
#line 768 "/home/yradouan/Documents/bison_expression/build/parser.cpp"
    break;
...
#line 776 "/home/yradouan/Documents/bison_expression/build/parser.cpp"
    break;

  case 9: // operation: IDENT
#line 87 "parser/parser.yy"
            {
        yylhs.value.as < ExpressionPtr > () = std::make_shared<Variable>(yystack_[0].value.as < std::string > ());
    }
#line 784 "/home/yradouan/Documents/bison_expression/build/parser.cpp"
    break;

  case 10: // operation: '(' operation ')'
#line 90 "parser/parser.yy"
                        {
        yylhs.value.as < ExpressionPtr > () = yystack_[1].value.as < ExpressionPtr > ();
    }
#line 792 "/home/yradouan/Documents/bison_expression/build/parser.cpp"
    break;
...
#line 800 "/home/yradouan/Documents/bison_expression/build/parser.cpp"
    break;
...
#line 808 "/home/yradouan/Documents/bison_expression/build/parser.cpp"
    break;
...
#line 816 "/home/yradouan/Documents/bison_expression/build/parser.cpp"
    break;

  case 14: // operation: operation '/' operation
...
#line 824 "/home/yradouan/Documents/bison_expression/build/parser.cpp"
    break;

  case 15: // operation: '-' operation
...
#line 832 "/home/yradouan/Documents/bison_expression/build/parser.cpp"
    break;


#line 836 "/home/yradouan/Documents/bison_expression/build/parser.cpp"
  ...
  const signed char
   Parser ::yypact_[] =
  {
      -2,     6,    -5,     0,    13,    13,    10,    24,    -5,    -5,
      22,    -5,    13,    -5,    -5,    14,    -5,    -2,    13,    13,
      13,    13,    22,    -5,    -5,    -3,    -3,    -5,    -5
  };
  ...
  {
       0,     0,     8,     9,     0,     0,     0,     0,     4,     5,
       6,     3,     0,     9,    15,     0,     1,     0,     0,     0,
       0,     0,     7,    10,     2,    12,    11,    13,    14
  };
  ...
  const signed char
   Parser ::yytable_[] =
  {
      14,    15,     1,     2,     3,     4,    20,    21,    22,    11,
      16,     5,    12,     0,    25,    26,    27,    28,     2,    13,
       4,    18,    19,    20,    21,    24,     5,    17,    23,    18,
      19,    20,    21
  };
  ...
  const signed char
   Parser ::yycheck_[] =
  {
       4,     5,     4,     5,     6,     7,     9,    10,    12,     3,
       0,    13,    12,    -1,    18,    19,    20,    21,     5,     6,
       7,     7,     8,     9,    10,    17,    13,     3,    14,     7,
       8,     9,    10
  };
  ...
  const signed char
   Parser ::yystos_[] =
  {
       0,     4,     5,     6,     7,    13,    16,    17,    18,    19,
      20,     3,    12,     6,    20,    20,     0,     3,     7,     8,
       9,    10,    20,    14,    16,    20,    20,    20,    20
  };

  const signed char
   Parser ::yyr1_[] =
  {
       0,    15,    16,    16,    17,    17,    18,    19,    20,    20,
      20,    20,    20,    20,    20,    20
  };
  ...
  "IDENT", "'-'", "'+'", "'*'", "'/'", "NEG", "'='", "'('", "')'",
  "$accept", "programme", "instruction", "expression", "affectation",
...
#line 1200 "/home/yradouan/Documents/bison_expression/build/parser.cpp"
